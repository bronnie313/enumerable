...
Enumerable is a classic teminal application that showscases how to use modules in a class
...
Clone this repository to your desired folder: ` @https://github.com/bronnie313/enumerable.git `
...
Install this project with: ` cd enumerable  `
` gem install `
...
To run the project, execute the following command:` ruby mylist.rb `
...
Feel free to check the [issues page](https://github.com/bronnie313/enumerable/issues).
...
This project is [MIT](https://github.com/bronnie313/enumerable?tab=MIT-1-ov-file#readme) licensed.
